...
public class UploadStep extends AbstractSubmissionStep
{
    ...
    protected static final Message T_publisher_info =
            message("xmlui.Submission.submit.UploadStep.publisher_info");
    protected static final Message T_publisher_info_help =
            message("xmlui.Submission.submit.UploadStep.publisher_info_help");
    ...
    protected static final Message T_sherpa_green =
        message("xmlui.aspect.sherpa.submission.green");

    protected static final Message T_sherpa_blue =
        message("xmlui.aspect.sherpa.submission.blue");

    protected static final Message T_sherpa_white =
        message("xmlui.aspect.sherpa.submission.white");

    protected static final Message T_sherpa_yellow =
        message("xmlui.aspect.sherpa.submission.yellow");
    ...
    public void make_sherpaRomeo_submission(Item item, Division divIn) throws WingException {
        ...
        if (ConfigurationManager.getBooleanProperty("webui.submission.sherparomeo-policy-enabled", true)){
            ...
            if(sherpaSubmitService.hasISSNs(context, item)) {
                    ...
                    if (journals != null) {
                        if (journals.size() > 0) {
                            ...
                            while (ijourn.hasNext()) {
                                ...
                                Message romeoColour = null;
                                switch(pub.getRomeocolour()){
                                    case "yellow": romeoColour = T_sherpa_yellow;break;
                                    case "blue": romeoColour = T_sherpa_blue;break;
                                    case "green": romeoColour = T_sherpa_green;break;
                                    case "white": romeoColour = T_sherpa_white;break;
                                }
                                sherpaList.addItem().addHighlight("sherpaStyle " + pub.getRomeocolour()).addContent(romeoColour);
                ...
                List sherpaList = div.addList("sherpaList"+i,"simple","sherpaList");
                sherpaList = div.addList("sherpaListEnd","simple","sherpaList");
