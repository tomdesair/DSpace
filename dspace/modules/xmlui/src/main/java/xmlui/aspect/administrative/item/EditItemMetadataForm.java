 ...
 */
package xmlui.aspect.administrative.item;
...
public class EditItemMetadataForm extends AbstractDSpaceTransformer {
    ...
    private static final Message T_template_head = message("xmlui.administrative.item.general.template_head");
        ...
        pageMeta.addMetadata("stylesheet", "screen", null, true).addContent("../../static/Datatables/DataTables-1.8.0/media/css/datatables.css");
//        pageMeta.addMetadata("stylesheet", "screen", null, true).addContent("../../themes/AtmireModules/lib/css/datatables-overrides.css");
        pageMeta.addMetadata("stylesheet", "screen", null, true).addContent("../../aspects/Submission/person-lookup.css");
        ...
        pageMeta.addMetadata("javascript", "static", null, true).addContent("aspects/Submission/person-lookup.js");
